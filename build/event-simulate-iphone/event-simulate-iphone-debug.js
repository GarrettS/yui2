    ...
    (function(){
        ...
        function simulateTouchEvent(doc, target, type, canBubble, cancelable, view,
            ...
            if (typeof touchEvent.initTouchEvent == "function") {
                touchEvent.initTouchEvent(type, canBubble, cancelable, view,
...
YAHOO.register("event-simulate-iphone", YAHOO.util.UserAction, {version: "@VERSION@", build: "@BUILD@"});
